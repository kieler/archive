...
public class MomlFactoryImpl extends EFactoryImpl implements MomlFactory {
    ...
    public static MomlFactory init() {
		try {
			MomlFactory theMomlFactory = (MomlFactory)EPackage.Registry.INSTANCE.getEFactory("platform:/resource/org.ptolemy.moml/model/moml.xsd"); 
    ...
    public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case MomlPackage.DISPLAY_TYPE: return createDisplayType();
	...
	public DisplayType createDisplayType() {
		DisplayTypeImpl displayType = new DisplayTypeImpl();
		return displayType;
	}
