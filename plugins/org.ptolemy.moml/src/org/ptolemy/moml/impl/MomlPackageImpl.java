...
public class MomlPackageImpl extends EPackageImpl implements MomlPackage {
	 ...
	 * @generated
	 */
	private EClass displayTypeEClass = null;
	 ...
	 * @see org.ptolemy.moml.MomlPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
    ...
    public EReference getClassType_Unlink() {
		return (EReference)classTypeEClass.getEStructuralFeatures().get(19);
	}
    ...
    public EAttribute getClassType_Source() {
		return (EAttribute)classTypeEClass.getEStructuralFeatures().get(22);
	}
	...
	public EAttribute getDisplayType_Name() {
		return (EAttribute)displayTypeEClass.getEStructuralFeatures().get(0);
	}
    ...
    public EAttribute getEntityType_Source() {
		return (EAttribute)entityTypeEClass.getEStructuralFeatures().get(22);
	}
    ...
    public void createPackageContents() {
		...
		createEReference(classTypeEClass, CLASS_TYPE__DISPLAY);
		...
		displayTypeEClass = createEClass(DISPLAY_TYPE);
		createEAttribute(displayTypeEClass, DISPLAY_TYPE__NAME);
		...
		createEReference(documentRootEClass, DOCUMENT_ROOT__DISPLAY);
		...
		createEReference(entityTypeEClass, ENTITY_TYPE__DISPLAY);
    ...
    public void initializePackageContents() {
		...
		initEReference(getClassType_Display(), this.getDisplayType(), null, "display", null, 0, -1, ClassType.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		...
		initEClass(displayTypeEClass, DisplayType.class, "DisplayType", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getDisplayType_Name(), ecorePackage.getEString(), "name", null, 1, 1, DisplayType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getDocumentRoot_Display(), this.getDisplayType(), null, "display", null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		...
		initEReference(getEntityType_Display(), this.getDisplayType(), null, "display", null, 0, -1, EntityType.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
