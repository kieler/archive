 ...
 * <ul>
 *   <li>{@link org.ptolemy.moml.impl.ClassTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link org.ptolemy.moml.impl.ClassTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link org.ptolemy.moml.impl.ClassTypeImpl#getConfigure <em>Configure</em>}</li>
 *   <li>{@link org.ptolemy.moml.impl.ClassTypeImpl#getDeleteEntity <em>Delete Entity</em>}</li>
 *   <li>{@link org.ptolemy.moml.impl.ClassTypeImpl#getDeletePort <em>Delete Port</em>}</li>
 *   <li>{@link org.ptolemy.moml.impl.ClassTypeImpl#getDeleteRelation <em>Delete Relation</em>}</li>
 *   <li>{@link org.ptolemy.moml.impl.ClassTypeImpl#getDirector <em>Director</em>}</li>
 *   <li>{@link org.ptolemy.moml.impl.ClassTypeImpl#getDisplay <em>Display</em>}</li>
 *   <li>{@link org.ptolemy.moml.impl.ClassTypeImpl#getDoc <em>Doc</em>}</li>
 *   <li>{@link org.ptolemy.moml.impl.ClassTypeImpl#getEntity <em>Entity</em>}</li>
 *   <li>{@link org.ptolemy.moml.impl.ClassTypeImpl#getGroup1 <em>Group1</em>}</li>
 *   <li>{@link org.ptolemy.moml.impl.ClassTypeImpl#getImport <em>Import</em>}</li>
 *   <li>{@link org.ptolemy.moml.impl.ClassTypeImpl#getInput <em>Input</em>}</li>
 *   <li>{@link org.ptolemy.moml.impl.ClassTypeImpl#getLink <em>Link</em>}</li>
 *   <li>{@link org.ptolemy.moml.impl.ClassTypeImpl#getPort <em>Port</em>}</li>
 *   <li>{@link org.ptolemy.moml.impl.ClassTypeImpl#getProperty <em>Property</em>}</li>
 *   <li>{@link org.ptolemy.moml.impl.ClassTypeImpl#getRelation <em>Relation</em>}</li>
 *   <li>{@link org.ptolemy.moml.impl.ClassTypeImpl#getRename <em>Rename</em>}</li>
 *   <li>{@link org.ptolemy.moml.impl.ClassTypeImpl#getRendition <em>Rendition</em>}</li>
 *   <li>{@link org.ptolemy.moml.impl.ClassTypeImpl#getUnlink <em>Unlink</em>}</li>
 *   <li>{@link org.ptolemy.moml.impl.ClassTypeImpl#getExtends <em>Extends</em>}</li>
 *   <li>{@link org.ptolemy.moml.impl.ClassTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.ptolemy.moml.impl.ClassTypeImpl#getSource <em>Source</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ClassTypeImpl extends EObjectImpl implements ClassType {
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case MomlPackage.CLASS_TYPE__DISPLAY:
