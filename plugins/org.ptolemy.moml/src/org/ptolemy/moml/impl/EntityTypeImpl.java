 ...
 * <ul>
 *   <li>{@link org.ptolemy.moml.impl.EntityTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link org.ptolemy.moml.impl.EntityTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link org.ptolemy.moml.impl.EntityTypeImpl#getConfigure <em>Configure</em>}</li>
 *   <li>{@link org.ptolemy.moml.impl.EntityTypeImpl#getDeleteEntity <em>Delete Entity</em>}</li>
 *   <li>{@link org.ptolemy.moml.impl.EntityTypeImpl#getDeletePort <em>Delete Port</em>}</li>
 *   <li>{@link org.ptolemy.moml.impl.EntityTypeImpl#getDeleteRelation <em>Delete Relation</em>}</li>
 *   <li>{@link org.ptolemy.moml.impl.EntityTypeImpl#getDirector <em>Director</em>}</li>
 *   <li>{@link org.ptolemy.moml.impl.EntityTypeImpl#getDoc <em>Doc</em>}</li>
 *   <li>{@link org.ptolemy.moml.impl.EntityTypeImpl#getDisplay <em>Display</em>}</li>
 *   <li>{@link org.ptolemy.moml.impl.EntityTypeImpl#getEntity <em>Entity</em>}</li>
 *   <li>{@link org.ptolemy.moml.impl.EntityTypeImpl#getGroup1 <em>Group1</em>}</li>
 *   <li>{@link org.ptolemy.moml.impl.EntityTypeImpl#getImport <em>Import</em>}</li>
 *   <li>{@link org.ptolemy.moml.impl.EntityTypeImpl#getInput <em>Input</em>}</li>
 *   <li>{@link org.ptolemy.moml.impl.EntityTypeImpl#getLink <em>Link</em>}</li>
 *   <li>{@link org.ptolemy.moml.impl.EntityTypeImpl#getPort <em>Port</em>}</li>
 *   <li>{@link org.ptolemy.moml.impl.EntityTypeImpl#getProperty <em>Property</em>}</li>
 *   <li>{@link org.ptolemy.moml.impl.EntityTypeImpl#getRelation <em>Relation</em>}</li>
 *   <li>{@link org.ptolemy.moml.impl.EntityTypeImpl#getRename <em>Rename</em>}</li>
 *   <li>{@link org.ptolemy.moml.impl.EntityTypeImpl#getRendition <em>Rendition</em>}</li>
 *   <li>{@link org.ptolemy.moml.impl.EntityTypeImpl#getUnlink <em>Unlink</em>}</li>
 *   <li>{@link org.ptolemy.moml.impl.EntityTypeImpl#getClass1 <em>Class1</em>}</li>
 *   <li>{@link org.ptolemy.moml.impl.EntityTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.ptolemy.moml.impl.EntityTypeImpl#getSource <em>Source</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EntityTypeImpl extends EObjectImpl implements EntityType {
	...
	public EList<DisplayType> getDisplay() {
		return getGroup().list(MomlPackage.Literals.ENTITY_TYPE__DISPLAY);
	}
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case MomlPackage.ENTITY_TYPE__DISPLAY:
    ...
    public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case MomlPackage.ENTITY_TYPE__DISPLAY:
				getDisplay().clear();
				getDisplay().addAll((Collection<? extends DisplayType>)newValue);
				return;
			case MomlPackage.ENTITY_TYPE__ENTITY:
				getEntity().clear();
