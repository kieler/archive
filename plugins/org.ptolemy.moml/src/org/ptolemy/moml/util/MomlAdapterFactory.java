...
public class MomlAdapterFactory extends AdapterFactoryImpl {
    ...
    protected MomlSwitch<Adapter> modelSwitch =
        new MomlSwitch<Adapter>() {
			...
			@Override
			public Adapter caseDisplayType(DisplayType object) {
				return createDisplayTypeAdapter();
			}
			@Override
    ...
    /**
	 * Creates a new adapter for an object of class '{@link org.ptolemy.moml.DisplayType <em>Display Type</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
