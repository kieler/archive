 ...
 * <ul>
 *   <li>{@link org.ptolemy.moml.Moml.VertexType#getGroup <em>Group</em>}</li>
 *   <li>{@link org.ptolemy.moml.Moml.VertexType#getConfigure <em>Configure</em>}</li>
 *   <li>{@link org.ptolemy.moml.Moml.VertexType#getDoc <em>Doc</em>}</li>
 *   <li>{@link org.ptolemy.moml.Moml.VertexType#getLocation <em>Location</em>}</li>
 *   <li>{@link org.ptolemy.moml.Moml.VertexType#getProperty <em>Property</em>}</li>
 *   <li>{@link org.ptolemy.moml.Moml.VertexType#getRename <em>Rename</em>}</li>
 *   <li>{@link org.ptolemy.moml.Moml.VertexType#getName <em>Name</em>}</li>
 *   <li>{@link org.ptolemy.moml.Moml.VertexType#getPathTo <em>Path To</em>}</li>
 *   <li>{@link org.ptolemy.moml.Moml.VertexType#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.ptolemy.moml.Moml.MomlPackage#getVertexType()
...
public interface VertexType extends EObject {
     ...
     * @see org.ptolemy.moml.Moml.MomlPackage#getVertexType_Group()
     ...
     * @see org.ptolemy.moml.Moml.MomlPackage#getVertexType_Configure()
     ...
     * @see org.ptolemy.moml.Moml.MomlPackage#getVertexType_Doc()
     * @model containment="true" transient="true" volatile="true" derived="true"
     ...
     * The list contents are of type {@link org.ptolemy.moml.Moml.LocationType}.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @see org.ptolemy.moml.Moml.MomlPackage#getVertexType_Location()
     * @model containment="true" transient="true" volatile="true" derived="true"
     ...
     * @see org.ptolemy.moml.Moml.MomlPackage#getVertexType_Property()
     * @model containment="true" transient="true" volatile="true" derived="true"
     ...
     * @see org.ptolemy.moml.Moml.MomlPackage#getVertexType_Rename()
     * @model containment="true" transient="true" volatile="true" derived="true"
     ...
     * @see #setName(String)
     * @see org.ptolemy.moml.Moml.MomlPackage#getVertexType_Name()
     * @model required="true"
    ...
    /**
     * Sets the value of the '{@link org.ptolemy.moml.Moml.VertexType#getName <em>Name</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see org.ptolemy.moml.Moml.MomlPackage#getVertexType_PathTo()
    ...
    /**
     * Sets the value of the '{@link org.ptolemy.moml.Moml.VertexType#getPathTo <em>Path To</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see #setValue(String)
     * @see org.ptolemy.moml.Moml.MomlPackage#getVertexType_Value()
    ...
    /**
     * Sets the value of the '{@link org.ptolemy.moml.Moml.VertexType#getValue <em>Value</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
