 ...
 * <ul>
 *   <li>{@link org.ptolemy.moml.Moml.RelationType#getGroup <em>Group</em>}</li>
 *   <li>{@link org.ptolemy.moml.Moml.RelationType#getConfigure <em>Configure</em>}</li>
 *   <li>{@link org.ptolemy.moml.Moml.RelationType#getDoc <em>Doc</em>}</li>
 *   <li>{@link org.ptolemy.moml.Moml.RelationType#getProperty <em>Property</em>}</li>
 *   <li>{@link org.ptolemy.moml.Moml.RelationType#getRename <em>Rename</em>}</li>
 *   <li>{@link org.ptolemy.moml.Moml.RelationType#getVertex <em>Vertex</em>}</li>
 *   <li>{@link org.ptolemy.moml.Moml.RelationType#getClass_ <em>Class</em>}</li>
 *   <li>{@link org.ptolemy.moml.Moml.RelationType#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.ptolemy.moml.Moml.MomlPackage#getRelationType()
...
public interface RelationType extends EObject {
     ...
     * @see org.ptolemy.moml.Moml.MomlPackage#getRelationType_Group()
     ...
     * @see org.ptolemy.moml.Moml.MomlPackage#getRelationType_Configure()
     ...
     * @see org.ptolemy.moml.Moml.MomlPackage#getRelationType_Doc()
     * @model containment="true" transient="true" volatile="true" derived="true"
     ...
     * @see org.ptolemy.moml.Moml.MomlPackage#getRelationType_Property()
     * @model containment="true" transient="true" volatile="true" derived="true"
     ...
     * @see org.ptolemy.moml.Moml.MomlPackage#getRelationType_Rename()
     * @model containment="true" transient="true" volatile="true" derived="true"
     ...
     * The list contents are of type {@link org.ptolemy.moml.Moml.VertexType}.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @see org.ptolemy.moml.Moml.MomlPackage#getRelationType_Vertex()
     * @model containment="true" transient="true" volatile="true" derived="true"
     ...
     * @see #setClass(String)
     * @see org.ptolemy.moml.Moml.MomlPackage#getRelationType_Class()
    ...
    /**
     * Sets the value of the '{@link org.ptolemy.moml.Moml.RelationType#getClass_ <em>Class</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see #setName(String)
     * @see org.ptolemy.moml.Moml.MomlPackage#getRelationType_Name()
     * @model required="true"
    ...
    /**
     * Sets the value of the '{@link org.ptolemy.moml.Moml.RelationType#getName <em>Name</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
