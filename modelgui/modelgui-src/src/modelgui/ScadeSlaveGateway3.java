...
import exceptions.CannotFindVariableException;
import exceptions.ClientException;
import exceptions.SimulationAlreadyStartedException;
...
public class ScadeSlaveGateway3 extends AbstractGateway {
	...
	private static ScadeSlaveGateway3 me;
	 ...
	 *
	 */
	public ScadeSlaveGateway3(String outputPath, String inputPath) {
		super();
	...
	public void startSimulation(String configuration, String rootnode)
		...
		conf += "\"";
		try {
			logger.info("Starting SCADE simulation interface... ");
			SVGApplication.getProgressBar().setVisible(true);
