...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
 const mxArray * prhs[] )
{
  extern unsigned int sf_elevator2_process_check_sum_call( int nlhs, mxArray *
   plhs[], int nrhs, const mxArray * prhs[] );

  if(sf_elevator2_process_check_sum_call(nlhs,plhs,nrhs,prhs)) return 1;
  return 0;
}
unsigned int sf_process_autoinheritence_call( int nlhs, mxArray * plhs[], int
 nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_elevator2_autoinheritance_info( int nlhs, mxArray *
   plhs[], int nrhs, const mxArray * prhs[] );
  if(sf_elevator2_autoinheritance_info(nlhs,plhs,nrhs,prhs)) return 1;
  return 0;
}
...
extern unsigned int sf_elevator2_method_dispatcher(SimStruct *S, const char
...
{
  if(sf_elevator2_method_dispatcher(simstructPtr,chartName,method,data)) return
  1;
  return 0;
}
extern void elevator2_terminator(void);
void sf_machine_global_terminator(void)
{
  if(sfMachineGlobalTerminatorCallable) {
    ...
    elevator2_terminator();
    sf_debug_terminate();
  }
  return;
}
extern void elevator2_initializer(void);
extern void elevator2_register_exported_symbols(SimStruct* S);
extern void elevator2_debug_initialize(void);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  elevator2_register_exported_symbols(S);
}
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if(sfMachineGlobalInitializerCallable) {
    ...
    if(!simModeIsRTWGen) {
      elevator2_debug_initialize();
    }
    elevator2_initializer();
  }
  return;
}
