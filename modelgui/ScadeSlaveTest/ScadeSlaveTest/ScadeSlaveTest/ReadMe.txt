========================================================================
    KONSOLENANWENDUNG: ScadeSlaveTest-Projektübersicht
========================================================================

Diese ScadeSlaveTest-Anwendung wurde vom Anwendungs-Assistenten
für Sie erstellt.  

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien,
aus denen Ihre ScadeSlaveTest–Anwendung besteht.


ScadeSlaveTest.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    mit dem Namen "ScadeSlaveTest.pch" und eine 
