...
/**
 * A class that holds parameters for the program. Can parse the command line to initialize itself.
 * 
 * @author cds
 */
public class Parameters {
    ...
    private static class ArrayIterator {
         ...
         * 
         * @return {@code true} if there's another element to return, {@code false} otherwise.
         */
         ...
         *             if the element cannot be interpreted as an integer.
         * @throws NoSuchElementException
         *             if there is no next element.
         */
        public int nextInt() {
         ...
         * @throws NumberFormatException
         *             if the element cannot be interpreted as a float.
         * @throws NoSuchElementException
         *             if there is no next element.
         */
    ...
    /**
     * The probability for a port to be placed on the northern or southern side, with both sides
     * sharing an equal probability.
     */
    public float northSouthPortProb = 0.1f;

    public int randomSeed = 1;

    public boolean onlyTestOneNodeCount = false;

    public int exactNodeAmount = 100;
