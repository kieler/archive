...
public class RatingTaglet implements Taglet {
    ...
    private static final String ICON_PATH = "http://rtsys.informatik.uni-kiel.de/fisheye/browse"
            + "/~raw,r=HEAD/kieler/standalone/de.cau.cs.kieler.taglets/icons/";
    ...
    private static String generateMarkup(final String date, final boolean proposed,
        ...
        output.append(ratingName + ".png\" alt=\"");
        if (proposed && rating != Rating.RED) {
