...
public class TableData {
	...
	/** A flag indicating that the entry should be displayed as modified. */
	...
	/**
	 * Sets the modified display.
	 * 
	 * @param modifiedDisplay the new modified display
	 */
	public void setModifiedDisplay(boolean modifiedDisplay) {
	...
	/**
	 * Checks if is modified display.
	 * 
	 * @return true, if is modified display
	 */
	public boolean isModifiedDisplay() {
		return (this.modifiedDisplay);
	}
